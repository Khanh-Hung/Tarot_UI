...
const ERROR_CODE_MAP: Record<string, string> = {
  ...
  DAILY_QUOTA_EXCEEDED: "Bạn đã dùng hết lượt bói bài hôm nay. Hãy nhận thêm lượt năng lượng để tiếp tục nhé!",
  AD_REQUIRED_FOR_SPREAD: "Trải bài 3 lá chuyên sâu yêu cầu thêm 1 lượt năng lượng. Vui lòng nhận thêm lượt để mở khóa.",
  DAILY_AD_LIMIT_REACHED: "Bạn đã đạt giới hạn nhận thưởng tối đa 8 lượt/ngày. Hãy quay lại vào ngày mai nhé!",
...
const ENGLISH_PATTERNS: { pattern: RegExp; translation: string }[] = [
  ...
  { pattern: /watching a rewarded ad is required/i, translation: "Trải bài 3 lá chuyên sâu yêu cầu thêm 1 lượt năng lượng để mở khóa." },
  { pattern: /daily.*reading.*quota.*exceeded/i, translation: "Bạn đã dùng hết lượt bói bài hôm nay. Hãy nhận thêm lượt để tiếp tục nhé!" },
  { pattern: /daily.*rewarded.*ad.*limit/i, translation: "Bạn đã đạt giới hạn nhận tối đa trong ngày. Hãy quay lại vào ngày mai nhé!" },
